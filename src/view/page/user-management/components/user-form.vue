	...
	<div>
		<Form ref="userForm" :model="userForm" :rules="userRule" :label-width="90" :label-colon="true" label-position="left">
			...
			<FormItem label="所属组织" prop="belongOrgId">
				<Input :disabled="disEditor" readonly v-model="belongOrgName" search :enter-button="$t('choose')" placeholder="请选择所属组织" @on-search="showBelongOrgList"></Input>
